                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="card">
                        <div class="body bg-red">
                            ...
                            $sql = "INSERT INTO surat_keluar (tanggal,kd_unit,tujuan,hal) values ('".$tanggal."','".$unit."','".$tujuan."','".$hal."')";
                            $query = mysqli_query($koneksi, $sql);
                            $query = mysqli_query($koneksi, "SELECT * FROM surat_keluar WHERE hal = '".$hal."'");
